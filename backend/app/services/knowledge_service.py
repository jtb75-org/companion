...
async def generate_rag_answer(
    ...
    system_prompt = (
        ...
        "2. Citation requirements: For every claim, rule, or requirement you state, cite the "
        "specific part or section (e.g., \"20 CFR § 404.1520\") from the chunks, INLINE "
        "within the sentence it supports. Do NOT add a separate \"Citation:\", "
        "\"Citations:\", or \"Sources:\" line or list at the end of the answer — the cited "
        "sources are shown separately below your answer. Cite within the prose only.\n"
